...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="WSDL">
        <oracle-xsl-mapper:schema location="../WSDLs/process.wsdl"/>
        <oracle-xsl-mapper:rootElement name="res" namespace="http://vasplatform.mobifone.vn"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [MON JUL 20 16:06:33 ICT 2020].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <ns0:res>
      ...
      <ns0:SM>SUCC</ns0:SM>
      <ns0:pool>
        <xsl:for-each select="/ns0:pool/ns0:ps">
          <ns0:ps>
