...
<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.3.0(XSLT Build 170820.1700.2557) AT [MON JUL 20 16:01:05 ICT 2020].-->
  </oracle-xsl-mapper:schema>
  <xsl:key name="product" match="/ns0:pool/ns0:ps[@i = 1]/ns0:p" use="ns0:k"/>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <ns0:pool>
      <ns0:ps n="Global" i="1">
        <xsl:for-each select="/ns0:pool/ns0:ps[@i = 1]/ns0:p[generate-id() = generate-id(key('product',ns0:k)[1])]">
          <ns0:p>
            <ns0:k>
